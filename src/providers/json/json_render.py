...
def json_render(view_graph, view_name, config):
...
def _render_json_graph(view_graph : list[ViewPackage], view_name, config):
    ...
    json_dependencies = [relation for json_package in view_graph for relation in json_package.render_dependency_json()]
